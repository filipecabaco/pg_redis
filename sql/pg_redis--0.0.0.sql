...
CREATE INDEX IF NOT EXISTS list_0_key_idx  ON redis.list_0  (key);
CREATE INDEX IF NOT EXISTS list_1_key_idx  ON redis.list_1  (key);
CREATE INDEX IF NOT EXISTS list_2_key_idx  ON redis.list_2  (key);
CREATE INDEX IF NOT EXISTS list_3_key_idx  ON redis.list_3  (key);
CREATE INDEX IF NOT EXISTS list_4_key_idx  ON redis.list_4  (key);
CREATE INDEX IF NOT EXISTS list_5_key_idx  ON redis.list_5  (key);
CREATE INDEX IF NOT EXISTS list_6_key_idx  ON redis.list_6  (key);
CREATE INDEX IF NOT EXISTS list_7_key_idx  ON redis.list_7  (key);
CREATE INDEX IF NOT EXISTS list_8_key_idx  ON redis.list_8  (key);
CREATE INDEX IF NOT EXISTS list_9_key_idx  ON redis.list_9  (key);
CREATE INDEX IF NOT EXISTS list_10_key_idx ON redis.list_10 (key);
CREATE INDEX IF NOT EXISTS list_11_key_idx ON redis.list_11 (key);
CREATE INDEX IF NOT EXISTS list_12_key_idx ON redis.list_12 (key);
CREATE INDEX IF NOT EXISTS list_13_key_idx ON redis.list_13 (key);
CREATE INDEX IF NOT EXISTS list_14_key_idx ON redis.list_14 (key);
CREATE INDEX IF NOT EXISTS list_15_key_idx ON redis.list_15 (key);
